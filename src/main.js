...
(function() {
  ...
  const interactiveElements = document.querySelectorAll('a, button, label, input[type="submit"], input[type="button"], input[type="radio"], select, textarea, .clickable, [onclick]');
